...
public class ticket_details {
    ...
    public static void main(String[] args) {
        ...
        String url = "jdbc:mysql://localhost:3306/Ticket_Bookings"; 
        try {
            ...
            try (Connection connection = DriverManager.getConnection(url, username, password)) {
                ...
                while (true) {
                    ...
                    String DeleteQuery = "DELETE FROM tickets WHERE pnr_number = ?";
                    String ShowQuery = "Select * from tickets";
                    ...
                    if (choice == 1) {
                        ...
                        try (PreparedStatement preparedStatement = connection.prepareStatement(InsertQuery)) {
                            ...
                            if (rowsAffected > 0) {
                                ...
                                System.out.println("No details were added.");
                            }
                        }
                        ...
                        System.out.println("Enter the PNR number to delete the details : ");
                        ...
                        try (PreparedStatement preparedStatement = connection.prepareStatement(DeleteQuery)) {
                            ...
                            if (rowsAffected > 0) {
                                ...
                                System.out.println("No details were deleted.");
                            }
                        }
